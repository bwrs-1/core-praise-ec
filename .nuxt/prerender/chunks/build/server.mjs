import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, createVNode, Transition, mergeProps, toRefs, toRef, shallowRef, ref, computed, watch, nextTick, watchEffect, useId, provide, onScopeDispose, withDirectives, vShow, Fragment, toDisplayString, resolveDirective, reactive, inject as inject$1, toRaw, createTextVNode, capitalize, h, defineComponent as defineComponent$1, unref, Suspense, createApp, TransitionGroup, camelize, isRef, readonly, resolveDynamicComponent, Text, markRaw, resolveComponent, render, shallowReactive, onErrorCaptured, onServerPrefetch, effectScope, isReadonly, isShallow, isReactive, warn, defineAsyncComponent, getCurrentScope, withCtx, vModelText, cloneVNode, Teleport, withModifiers, isVNode, Comment, useSSRContext } from 'file:///workspaces/core-praise-ec/node_modules/vue/index.mjs';
import { $fetch } from 'file:///workspaces/core-praise-ec/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///workspaces/core-praise-ec/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///workspaces/core-praise-ec/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$2, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///workspaces/core-praise-ec/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///workspaces/core-praise-ec/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///workspaces/core-praise-ec/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///workspaces/core-praise-ec/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///workspaces/core-praise-ec/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CclgD8KK.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DmDtWBgC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CvuXlvRW.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter$1 as u };
