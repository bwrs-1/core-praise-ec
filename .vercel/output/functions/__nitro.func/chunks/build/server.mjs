import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, createVNode, Transition, mergeProps, toRefs, toRef, shallowRef, ref, computed, watch, nextTick, watchEffect, useId, provide, onScopeDispose, withDirectives, vShow, Fragment, toDisplayString, resolveDirective, reactive, inject as inject$1, toRaw, createTextVNode, capitalize, h, defineComponent as defineComponent$1, unref, Suspense, createApp, TransitionGroup, camelize, isRef, readonly, resolveDynamicComponent, Text, markRaw, resolveComponent, render, shallowReactive, onErrorCaptured, onServerPrefetch, effectScope, isReadonly, isShallow, isReactive, warn, defineAsyncComponent, getCurrentScope, withCtx, vModelText, cloneVNode, Teleport, withModifiers, isVNode, Comment, useSSRContext } from 'vue';
import { i as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, o as executeAsync, e as createError$1, t as toRouteMatcher, p as createRouter$1, q as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BWhVF0Dq.mjs')
  }
];
