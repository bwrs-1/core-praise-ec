...
export declare function useVariant(props: MaybeRef<VariantProps>, name?: string): {
    colorClasses: import("vue").Ref<string[], string[]>;
    colorStyles: import("vue").Ref<import("vue").CSSProperties, import("vue").CSSProperties>;
